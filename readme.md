...
## 🚀 What I'm Working On
- Building out the [Electrochemical-Impedance-Spectroscopy](https://github.com/nick-gould/Electrochemical-Impedance-Spectroscopy) as a proper library and include curve-fitting to real world data
...
Code for simulating [EIS](https://www.gamry.com/application-notes/EIS/basics-of-electrochemical-impedance-spectroscopy/) responses from equivalent circuits, targeting battery applications.
...
Code for solving the [Peng-Robinson Equation of State](https://en.wikipedia.org/wiki/Cubic_equations_of_state#Peng%E2%80%93Robinson_equation_of_state), which is unreasonably accurate for a model from the 1970s. It requires knowing the critical temperature and pressure for a component, as well as acentric factor. If these are not available, there are plural methods for estimating them including methods by Lydersen, Fedors, or Joback.
